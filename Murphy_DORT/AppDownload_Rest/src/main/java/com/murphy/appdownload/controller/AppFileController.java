...
//		return "Working";
	...
	public void downloadFile(HttpServletResponse res, @RequestParam("fileType") String fileType, @RequestParam(value="fileVersion", required=false) String fileVersion, @RequestParam("application") String application){
		AppFileDto dto = fileLocal.getFile(fileType, fileVersion, application);
